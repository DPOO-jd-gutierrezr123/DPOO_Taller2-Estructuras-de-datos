...
public class SandboxMapas
{
    ...
    {	
    	...
    	listaValores.sort((a, b) -> a.compareTo(b));
    ...
    public String getPrimera( )
    {
    	...
    	return mapaCadenas.get(getLlavesComoListaInvertida().getLast());
    }
    ...
    public String getUltima( )
    {
    	...
    	return mapaCadenas.get(getLlavesComoListaInvertida().getFirst());
    }
